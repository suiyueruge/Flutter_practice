...
import 'package:myapp/detail/TodoListWidget.dart';
import 'package:myapp/http/API.dart';
import 'package:myapp/bean/movie_detail_bean.dart';
import 'package:myapp/detail/detail_title_widget.dart';
import 'package:myapp/movie/constant.dart';
import 'package:myapp/detail/score_start.dart';
import 'dart:math' as math;
import 'package:myapp/router.dart';
import 'package:myapp/bean/comments_entity.dart';
import 'package:myapp/movie/rating_bar.dart';
import 'package:myapp/movie/animal_photo.dart';
import 'package:flutter/rendering.dart';
import 'package:myapp/http/http_request.dart';
import 'package:myapp/bean/movie_long_comments_entity.dart';
import 'package:myapp/detail/bottom_drag_widget.dart';
import 'package:myapp/detail/todoList_widget.dart';
import 'package:myapp/detail/long_comment_widget.dart';
...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
          ...
          //         body: _getBody(),
          //         dragContainer: TodoDragContainer(
          //           drawer: Container(
          //             child: TodoOverscrollNotificationWidget(
          //               child: TodoListView(todoList: [1, 1, 1, 1]),
          //             ),
          ...
          //           ),
          //           defaultShowHeight: screenH * 0.12,
          //           height: screenH * 0.8,
  ...
  Future<void> requestAPI() async {
    String responseStr =
        await rootBundle.loadString('mock/subject_26266893.json');
    var responseJson = json.decode(responseStr);
    _movieDetailBean = MovieDetailBean.fromJson(responseJson);

    pickColor = Color(0xFF7CB342);
    // pickColor = Colors.white54;

    String responseStrz = await rootBundle.loadString('mock/comments.json');
    var responseJsonz = json.decode(responseStrz);
    commentsEntity = CommentsEntity.fromJson(responseJsonz);

    String responseStrzz = await rootBundle.loadString('mock/reviews.json');
    var responseJsonzz = json.decode(responseStrzz);
    movieLongCommentReviews = MovieLongCommentsEntity.fromJson(responseJsonzz);
