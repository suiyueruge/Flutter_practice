  ...
  MovieLongCommentsEntity.fromJson(Map<String, dynamic> json) {
    ...
    if (json['reviews'] != null) {
      ...
      json['reviews'].forEach((v) {
        reviews.add(new MovieLongCommentReviews.fromJson(v));
      });
    }
    subject = json['subject'] != null
        ? new MovieLongCommentsSubject.fromJson(json['subject'])
        : null;
    count = json['count'];
    start = json['start'];
  }
...
class MovieLongCommentReviews {
  ...
  MovieLongCommentReviews.fromJson(Map<String, dynamic> json) {
    ...
    author = json['author'] != null
        ? new MovieLongCommentsReviewsAuthor.fromJson(json['author'])
        : null;
    rating = json['rating'] != null
        ? new MovieLongCommentsReviewsRating.fromJson(json['rating'])
        : null;
    alt = json['alt'];
...
class MovieLongCommentsSubject {
  ...
  MovieLongCommentsSubject.fromJson(Map<String, dynamic> json) {
    images = json['images'] != null
        ? new MovieLongCommentsSubjectImages.fromJson(json['images'])
        : null;
    ...
    if (json['directors'] != null) {
      ...
      json['directors'].forEach((v) {
        directors.add(new MovieLongCommantsSubjectDirectors.fromJson(v));
      });
    }
    rating = json['rating'] != null
        ? new MovieLongCommentsSubjectRating.fromJson(json['rating'])
        : null;
    alt = json['alt'];
    title = json['title'];
    ...
    if (json['casts'] != null) {
      ...
      json['casts'].forEach((v) {
        casts.add(new MovieLongCommantsSubjectCasts.fromJson(v));
      });
    }
...
class MovieLongCommantsSubjectDirectors {
  ...
  MovieLongCommantsSubjectDirectors.fromJson(Map<String, dynamic> json) {
    ...
    avatars = json['avatars'] != null
        ? new MovieLongCommentsSubjectDirectorsAvatars.fromJson(json['avatars'])
        : null;
    nameEn = json['name_en'];
  }
...
class MovieLongCommentsSubjectRating {
  ...
  MovieLongCommentsSubjectRating.fromJson(Map<String, dynamic> json) {
    ...
    details = json['details'] != null
        ? new MovieLongCommentsSubjectRatingDetails.fromJson(json['details'])
        : null;
    stars = json['stars'];
  }
...
class MovieLongCommantsSubjectCasts {
  ...
  MovieLongCommantsSubjectCasts.fromJson(Map<String, dynamic> json) {
    ...
    id = json['id'];
    avatars = json['avatars'] != null
        ? new MovieLongCommentsSubjectCastsAvatars.fromJson(json['avatars'])
        : null;
    nameEn = json['name_en'];
  }
